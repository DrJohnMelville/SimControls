...
public static class CreateSequenceReader
{
    public static SequenceReader<byte> AsSequenceReader(this byte[] input) =>
        new SequenceReader<byte>(new ReadOnlySequence<byte>(input));
}